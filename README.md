...
- Branch: [`airflow-3-1`](https://github.com/astronomer/webinar-demos/tree/airflow-3-1) - [What's new in Apache Airflow® 3.1](https://www.astronomer.io/events/webinars/airflow-3-1-release-video/)
- Branch: [`etl-elt-airflow-snowflake`](https://github.com/astronomer/webinar-demos/tree/etl-elt-airflow-snowflake) - [Production-Ready ELT Pipelines with Airflow 3 and Snowflake](https://www.astronomer.io/events/webinars/elt-pipelines-with-airflow-3-and-snowflake-video/)
- Branch: [`best-practices-debugging`](https://github.com/astronomer/webinar-demos/tree/best-practices-debugging) - [Best practices for debugging your Airflow Dags](https://www.astronomer.io/events/webinars/best-practices-for-debugging-your-airflow-dags-video/)
- Branch: [`data-quality`](https://github.com/astronomer/webinar-demos/tree/data-quality) - [Stopping bad data before it breaks your Airflow pipelines](https://www.astronomer.io/events/webinars/stopping-bad-data-before-it-breaks-your-airflow-pipelines-video/)
- Branch: [`local-data-engineering`](https://github.com/astronomer/webinar-demos/tree/local-data-engineering) - [Local data engineering in the agentic era](https://www.astronomer.io/events/webinars/local-data-engineering-in-the-agentic-era-video/)
- Branch: [`intro-to-airflow`](https://github.com/astronomer/webinar-demos/tree/intro-to-airflow) - [Intro to Apache Airflow®: From the basics to agentic workflows](https://www.astronomer.io/events/webinars/intro-to-airflow-video/)
- Branch: [`common-ai`](https://github.com/astronomer/webinar-demos/tree/common-ai) - [Airflow for Production-ready AI](https://www.astronomer.io/events/webinars/airflow-for-production-ready-ai-video/)
