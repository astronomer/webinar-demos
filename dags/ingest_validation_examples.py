...
@dag(
    ...
    schedule=(
        Dataset("file://include/examples/validation_examples/examples_long")
        | Dataset("file://include/examples/validation_examples/examples_short")
    ),
    catchup=False,
    tags=["ingest"],
    default_args={
...
def ingest_validation_examples():
    ...
    def create_jsonl_from_txt_examples(
        example_folder, output_path="include/examples/validation_examples/formatted_examples/"
    ):
        """
        ...
        directory = os.path.join("include/examples/validation_examples/", example_folder)
        ...
        context["custom_map_index"] = (
            f"Parsing examples from: include/examples/validation_examples/{directory_name}"
        )

    @task(outlets=[Dataset("file://include/examples/validation_examples/formatted_examples/")])
    def examples_ingested():
        print("Examples ingested successfully.")

    chain(
        create_jsonl_from_txt_examples.expand(
            example_folder=get_example_folders("include/examples/validation_examples/")
        ),
        examples_ingested(),
    )
